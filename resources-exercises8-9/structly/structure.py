"""
Clase base Structure con metaclase y soporte de iteración (ejercicios 7.x y 8.x).
"""
...
__all__ = ["Structure", "typed_structure"]
...
class Structure(metaclass=StructureMeta):
    ...
    def __setattr__(self, attribute_name: str, attribute_value: Any) -> None:
        if attribute_name.startswith("_") or attribute_name in self._fields:
