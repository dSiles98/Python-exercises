"""
Pruebas unitarias para stock.py.
"""
...
class TestStock(unittest.TestCase):
    ...
    def test_eq(self) -> None:
        first = stock.Stock("GOOG", 100, 490.1)
        second = stock.Stock("GOOG", 100, 490.1)
        self.assertTrue(first == second)

    def test_iteration_and_unpacking(self) -> None:
        stock_position = stock.Stock("GOOG", 100, 490.1)
        self.assertEqual(list(stock_position), ["GOOG", 100, 490.1])
        name, shares, price = stock_position
        self.assertEqual((name, shares, price), ("GOOG", 100, 490.1))
