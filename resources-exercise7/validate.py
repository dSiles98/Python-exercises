"""
Validadores de tipo/valor y decoradores de validación (ejercicios 6.5 y 7.x).
"""
...
def validated(wrapped_function: F) -> F:
    """
    Decorador que valida argumentos y retorno según anotaciones (ejercicio 7.1).
    Funciona con funciones y métodos de instancia.
    """
...
def enforce(**annotation_validators: Validator) -> Callable[[F], F]:
    """
    Decorador con validadores explícitos por parámetro (ejercicio 7.2d).
    Usar ``return_`` para validar el valor de retorno.
    """
